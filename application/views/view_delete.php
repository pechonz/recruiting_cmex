                    ...
                    <div class="col-md-10 offset-md-1">                    
                        ...
                        <div class="form-row mt-4">
                            <div class="col-sm-4 pb-3">
                                ...
                                <div>
                                    <select class="custom-select" name="position_id" disabled>
                            ...
                            <div class="col-sm-4 pb-3">
                                ...
                                <div>
                                    <select class="custom-select" name="ward_id" disabled>
                            ...
                            <div class="col-sm-4 pb-3">
                                ...
                                <div>
                                    <select class="custom-select" name="applicant_type" disabled>
                            ...
                            <div class="col-sm-3 pb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="wage" value="<?php echo $query3->wage;?>" disabled>
                                </div>
                            </div>
                            <div class="col-sm-3 pb-3">
                                <label style="font-weight: bold;" for="exampleFirst">ตำแหน่งว่าง</label>
                                <input type="text" class="form-control" name="position_cnt" value="<?php echo $query3->position_cnt;?>" disabled>
                            </div>
                            <div class="col-sm-3 pb-3">
                                <label style="font-weight: bold;">วันที่สิ้นสุดรับสมัคร</label>
                                <input type="text" class="form-control datepicker" name="closing_date" value="<?php echo $query3->closing_date;?>" disabled>
                            </div>
                            <div class="col-sm-6 pb-3">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input examChk" name="exam" id="exam_check" disabled>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <?php if ($query3->exam_date != 0000-00-00): ?>
                                            <input type="text" class="form-control datepicker exam" name="exam_date" value="<?php echo $query3->exam_date;?>" disabled>
                                        <?php else: ?>
                                            <input type="text" class="form-control datepicker exam" name="exam_date" value="" disabled>
                                        <?php endif; ?>  
                                    </div>
                                    <div class="col">
                                        <label style="font-weight: bold;">วันที่ประกาศผล</label>
                                        <?php if ($query3->exam_announcement_date != 0000-00-00): ?>
                                            <input type="text" class="form-control datepicker exam" name="exam_an_date" value="<?php echo $query3->exam_announcement_date;?>" disabled> 
                                        <?php else: ?>
                                            <input type="text" class="form-control datepicker exam" name="exam_an_date" value="" disabled> 
                                        <?php endif; ?>  
                                        
                                    </div>
                                </div>
                                <div class="form-check">
                                  <input type="checkbox" class="form-check-input interviewChk" name="interview" id="interview_check" disabled>
                                ...
                                <div class="form-row">
                                  <div class="col">
                                      ...
                                      <?php if ($query3->interview_date != 0000-00-00): ?>
                                          <input type="text" class="form-control datepicker interview" name="interview_date" value="<?php echo $query3->interview_date;?>" disabled>
                                      <?php else: ?>
                                          <input type="text" class="form-control datepicker interview" name="interview_date" value="" disabled>
                                      <?php endif; ?>
                                  </div>
                                  <div class="col">
                                      <label style="font-weight: bold;">วันที่ประกาศผล</label>
                                      <?php if ($query3->interview_announcement_date != 0000-00-00): ?>
                                          <input type="text" class="form-control datepicker interview" name="interview_an_date" value="<?php echo $query3->interview_announcement_date;?>" disabled>
                                      <?php else: ?>
                                          <input type="text" class="form-control datepicker interview" name="interview_an_date" value="" disabled>
                                      <?php endif; ?>
